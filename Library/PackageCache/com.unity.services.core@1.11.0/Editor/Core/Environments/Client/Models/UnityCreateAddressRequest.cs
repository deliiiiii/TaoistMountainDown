...
{
    /// <summary>
    /// UnityCreateAddressRequest model
    /// </summary>
    [Preserve]
    [DataContract(Name = "unity_createAddress_request")]
    internal class UnityCreateAddressRequest
    {
        /// <summary>
        /// Creates an instance of UnityCreateAddressRequest.
        /// </summary>
        ...
        [Preserve]
        public UnityCreateAddressRequest(string firstName, string lastName, string email, string street, string locality, string postalCode, string country, string phoneNumer = default, string region = default)
        {
            FirstName = firstName;
            LastName = lastName;
            Email = email;
        ...
        /// <summary>
        /// Formats a UnityCreateAddressRequest into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a UnityCreateAddressRequest as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
